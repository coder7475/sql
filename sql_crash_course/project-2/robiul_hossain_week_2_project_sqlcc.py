# -*- coding: utf-8 -*-
"""Robiul Hossain - Week 2 Project - SQLCC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10kPHtIRE3xchu5EYO0o-SkjhtGeNw_Ng
...
"""
This vertically-scrollable table displays all of the data contained in the neighbourhoods table. Feel free to explore all four tables again to familiarize yourself with the data.
...
# TO BE COMPLETED
query = """
SELECT * from listings WHERE host LIKE 'Jos%'
"""
...
# TO BE COMPLETED
query = """
SELECT * FROM neighbourhoods WHERE neighbourhood_id=21
"""
...
# TO BE COMPLETED
query = """
SELECT * FROM calendar WHERE listing_id=22296011
"""
...
# TO BE COMPLETED
query = """
SELECT * FROM reviews WHERE listing_id=22296011
"""
...
# TO BE COMPLETED
query = """
SELECT AVG(price_in_dollar) FROM listings
"""
...
# TO BE COMPLETED
query = """
SELECT MAX(price_in_dollar) FROM listings
"""
...
# TO BE COMPLETED
query = """
SELECT MIN(price_in_dollar) FROM listings
"""
...
# TO BE COMPLETED
query = """
SELECT neighbourhood_id, count(*) FROM listings GROUP BY neighbourhood_id
"""
...
# TO BE COMPLETED
query = """
SELECT count(neighbourhood_id), neighbourhood_id FROM listings GROUP BY neighbourhood_id
"""
...
# TO BE COMPLETED
query = """
SELECT count(neighbourhood_id), neighbourhood_id
FROM listings
GROUP BY neighbourhood_id
...
You've made it to the end of the week 2 assignment! Awesome! Next step submit the project on the Uplimit platform by filling the form at the bottom here: https://uplimit.com/course/sql-crash-course/go/project-rvr5a
